...
import visaLogo from "../../assets/images/footer/visa_2x.webp";
import mastercardLogo from "../../assets/images/footer/mastercard_2x.webp";
import klarnaLogo from "../../assets/images/footer/klarna_2x.webp";
 ...
 * @param {Function} props.onValidate - Validation function that returns boolean (optional)
 */
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="bg-white border border-[#dedede] rounded-lg overflow-hidden">
          ...
          <div className="bg-[#f2f8f4] h-[50px] relative border-b border-[rgba(247,247,247,0.2)]">
            ...
            <div className="flex absolute right-5 top-1/2 gap-2 items-center -translate-y-1/2">
              ...
              <div className="bg-white border border-[rgba(0,0,0,0.07)] rounded px-2">
        ...
        {/* Terms and Place Order Button - Outside the bordered container */}
