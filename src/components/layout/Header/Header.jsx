  ...
  return (
    <header className="sticky top-0 z-50 bg-white">
      ...
      <nav className="px-4 py-3 md:hidden">
        ...
        {mobileMenuOpen && (
          <div className="pt-4 pb-4 mt-4 border-t border-gray-200">
            <div className="flex flex-col gap-4">
              <Link
                to="/products"
                className="font-['Funnel_Display'] text-[16px] text-black capitalize hover:text-[#0d8360] transition-colors"
              ...
              <button className="bg-[#0d8360] hover:bg-[#0a6b4f] text-white font-['Funnel_Display'] font-semibold text-[16px] px-5 py-3 rounded-full w-full transition-colors">
                Shop Now
              </button>
            </div>
          </div>
