      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8">
        <div className="relative rounded-[24px] md:rounded-[30px] overflow-hidden">
          ...
          <div className="flex relative flex-col gap-4 items-center px-6 py-10 text-center md:gap-5 md:py-14 md:px-12">
            ...
            <button className="bg-[#0d8360] hover:bg-[#0b7254] active:bg-[#095c45] transition-colors text-white rounded-full px-5 md:px-[19px] py-3 md:py-[12px] flex items-center gap-2 font-['Funnel_Display'] font-semibold text-[16px] leading-[24px] shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
              <img
                src={cartIcon}
                alt=""
                className="w-5 h-5"
