  ...
  return (
    <section className="bg-white">
      <div className="max-w-[1280px] mx-auto md:px-8 md:py-16 px-4 py-12">
        {/* Header */}
        <h2 className="font-['Funnel_Display'] text-center md:text-left font-semibold md:text-[48px] text-[32px] leading-[1.2] lg:leading-[56px] text-[#010907] mb-8 md:mb-10 lg:mb-[48px]">
