      ...
      <div className="relative h-full max-w-[1280px] mx-auto px-4 md:px-8 flex items-center">
        ...
        <div className="w-full max-w-[520px] md:max-w-[600px] space-y-6">
          ...
          <div className="space-y-4">
            {/* Main Heading */}
            <h1 className="font-['Funnel_Display'] font-medium text-3xl md:text-4xl lg:text-[50px] leading-snug md:leading-tight lg:leading-[58px] text-white whitespace-pre-wrap">
              {title}
            </h1>
